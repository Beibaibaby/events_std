...
# Add second plot to the same figure
plot!(temporal_frequencies, depression_ratios_fixed_F, 
    label="E → I", 
    marker=:circle, 
    markersize=2, 
    linewidth=5, 
...
# Save figure
# Save figure
savefig("../plots_for_paper/p8_new.png")
savefig("../plots_for_paper/p8_new.svg")
savefig("../plots_for_paper/p8_new.pdf")
...
p = plot(temporal_frequencies, depression_ratios, 
    ...
    tickfont=font(12),
    legendfont=font(12),
    xticks=:none,  # Remove x-axis tick labels
    yticks=:none   # Remove y-axis tick labels
)
...
# Save figure
savefig("../plots_for_paper/p8_new_label_off.png")
savefig("../plots_for_paper/p8_new_label_off.svg")
savefig("../plots_for_paper/p8_new_label_off.pdf")