...
include("sim.jl") # include the network simulation code
#to do
...
dir_name_in = get_arg("--dir_name_in", "./results")
...
init_weights_name = get_arg("--weights_file", "./hyperparameter/weights_record.jld2")  # Adjust the default as needed
